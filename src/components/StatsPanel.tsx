  ...
  return (
    <div className="hero-panel__stats" aria-label={t("stats.ariaLabel")}>
      ...
      >
        ...
        <span
          className="hero-panel__icon hero-panel__icon--nodes"
          aria-hidden="true"
        />
      ...
      >
        ...
        <span
          className="hero-panel__icon hero-panel__icon--branches"
          aria-hidden="true"
        />
        <span className="hero-panel__tooltip" role="tooltip">
      ...
      >
        ...
        <span
          className="hero-panel__icon hero-panel__icon--poems"
          aria-hidden="true"
        />
        <span className="hero-panel__tooltip" role="tooltip">
